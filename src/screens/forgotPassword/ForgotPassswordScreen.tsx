                        ...
                        <AppBlock style={{width: '100%'}}>
                            ...
                            <AppBlock mt={50}>
                                <AppBlock alignItems='center'>
                                    <AppText size={24} weight='700' semiBold color='#122457' mt={20} mb={10}>{t('forgot_password')}</AppText>
                                    <AppText size={14} weight='400' color='#554C46'>{t('forgot_password_description')}</AppText>
                                </AppBlock>
                                <AppBlock mt={20}>
                                    <AppText color='#122457' size={16} weight='500' regular>{t('account')}</AppText>
                                    <AppTextInput placeholder={t('enter_account')} leftIcon={faUser}/>
                                </AppBlock>
                            </AppBlock>
                        </AppBlock>
