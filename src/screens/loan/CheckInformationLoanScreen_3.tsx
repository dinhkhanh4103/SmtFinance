...
const CheckInformationLoanScreen_3 = ({navigation}: any) => {
  ...
  return (
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            ...
            <AppButton name={t('continue')} onPress={()=> navigation.navigate('CheckInformationLoanScreen_4')}/>
        </AppBlock>
    </AppSafeAreaView>
  )
}

export default CheckInformationLoanScreen_3