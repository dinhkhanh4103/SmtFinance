...
const CheckQuickLoanScreen_3 = ({navigation}: any) => {
        ...
        <AppBlock style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            <AppBlock>
                ...
                <AppBlock>
                    ...
                    <AppText size={20} weight='600' semiBold color={light.Primary} mt={4}>3/3</AppText>
                    ...
                    <AppBlock flex justifyContent='center' alignItems='center' background='rgba(0,0,0,0.4)'>
                        <AppBlock style={styles.modalContainer} alignItems='center' justifyContent='center'>
                            <AppBlock  alignItems='center' style={{width:'90%'}}>
                                <AppText size={16} weight='400' regular>Bạn có chắc chắn muốn bay nhanh với mức vay là <AppText size={16} weight='400' regular color={light.Primary}>20.000.000 VNĐ</AppText> không?</AppText>
                            </AppBlock>
                            
                            <TouchableOpacity onPress={()=>navigation.navigate('LoanSuccessScreen')}>
...
export default CheckQuickLoanScreen_3