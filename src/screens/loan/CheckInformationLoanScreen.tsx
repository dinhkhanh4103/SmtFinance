...
const CheckInformationLoanScreen = ({navigation}: any) => {
  ...
  return (
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            ...
            <AppButton name={t('continue')} onPress={()=> navigation.navigate('CheckInformationLoanScreen_2')}/>
        </AppBlock>
    </AppSafeAreaView>
  )
}

export default CheckInformationLoanScreen