...
const CheckInformationLoanScreen_4 = ({navigation}: any) => {
    ...
    <AppSafeAreaView>
        <AppBlock flex style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            ...
            <AppBlock>  
                ...
                <AppButton name={t('continue')} onPress={()=> navigation.navigate('CheckInformationLoanScreen_5')}/>    
            </AppBlock>
        </AppBlock>
    </AppSafeAreaView>
  )
...
export default CheckInformationLoanScreen_4