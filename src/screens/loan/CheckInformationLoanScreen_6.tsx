...
const CheckInformationLoanScreen_6 = ({navigation}: any) => {
                    ...
                    <AppBlock flex justifyContent='center' alignItems='center' background='rgba(0,0,0,0.4)'>
                        <AppBlock style={styles.modalContainer} alignItems='center' justifyContent='center'>
                            <AppBlock  alignItems='center' style={{width:'90%'}}>
                                <AppText size={16} weight='400' regular>Bạn có chắc chắn muốn tạo gói đầu tư với mức vay là <AppText size={16} weight='400' regular color={light.Primary}>185.000.000 VNĐ</AppText> không?</AppText>
                            </AppBlock>
...
export default CheckInformationLoanScreen_6