...
const CreateCallCapitalSucces = ({navigation}: any) => {
    ...
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: '100%'}} alignItems='center' justifyContent='space-between'>
            ...
            <AppBlock alignItems='center'>
                ...
                <AppText size={24} weight='600' semiBold color={light.Primary}  mt={20}>{t('create_investment_package_success')}</AppText>
                <AppText size={14} weight='400' regular mt={12}>{t('investment_package_approval_notification')}</AppText>
            </AppBlock>
...
export default CreateCallCapitalSucces