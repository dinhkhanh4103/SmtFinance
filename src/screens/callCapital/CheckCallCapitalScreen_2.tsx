...
const CheckCallCapitalScreen_2 = ({navigation}: any) => {
  ...
  return (
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            ...
            <AppButton name={t('continue')} onPress={()=> navigation.navigate('CheckCallCapitalScreen_3')} />
        </AppBlock>
    </AppSafeAreaView>
  )
}

export default CheckCallCapitalScreen_2