...
const CheckCallCapitalScreen_5 = ({navigation}: any) => {
    ...
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            ...
            <AppBlock style={{position:"absolute", bottom:0, width:"100%"}}>  
                <AppButton name={t('confirm')} onPress={()=> navigation.navigate('CheckCallCapitalScreen_6')}/>    
            </AppBlock>
        </AppBlock>
    </AppSafeAreaView>
  )
...
export default CheckCallCapitalScreen_5;