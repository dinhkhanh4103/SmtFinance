...
const CheckCallCapitalScreen_1 = ({navigation}: any) => {
  ...
  return (
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: "100%"}} justifyContent='space-between'>
            ...
            <AppButton name={t('continue')} onPress={()=> navigation.navigate('CheckCallCapitalScreen_2')}/>
        </AppBlock>
    </AppSafeAreaView>
  )
}

export default CheckCallCapitalScreen_1