...
const InvestSuccessScreen = ({navigation}: any) => {
    ...
    <AppSafeAreaView>
        <AppBlock style={{width:'95%', height: '100%'}} alignItems='center' justifyContent='space-between'>
            ...
            <AppBlock alignItems='center'>
                ...
                <AppText size={24} weight='600' semiBold color={light.Primary}  mt={20}>{t('investment_success')}</AppText>
                <AppText size={14} weight='400' regular mt={12}>{t('congratulations_investment_success')}</AppText>
            </AppBlock>
