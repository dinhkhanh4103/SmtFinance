...
const FingerprintSecurityScreen = ({navigation}:any) => {
  ...
  return (
    <AppSafeAreaView>
        <AppBlock flex style={{width:'95%'}} justifyContent='space-between'>
            ...
            <AppBlock flex>
                ...
                <AppBlock mt={30}>
                    <AppBlock alignItems='center'>
                        ...
                        <AppText mt={12}>{t('please_enter_password_before_fingerprint')}</AppText>
                    </AppBlock>
                    <AppBlock mt={20}>
            ...
            <AppBlock>
                <AppButton name={t('confirm')} onPress={()=>navigation.navigate('FingerprintSuccessScreen')}/>
            </AppBlock>
        </AppBlock>
    </AppSafeAreaView>
  )
...
export default FingerprintSecurityScreen