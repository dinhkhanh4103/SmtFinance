                    ...
                    <AppBlock flex alignItems='center' justifyContent='space-between'>
                        ...
                        <AppBlock>
                            <AppBlock alignItems='center'>
                                <AppText size={24} weight='700' semiBold color='#554C46' mt={20} mb={10}>{t('register')}</AppText>
                                <AppText size={14} weight='400' color='#554C46'>{t('description_signup')}</AppText>
                            </AppBlock>
                            <AppBlock mt={20}>
                                <AppText color='#554C46' size={16} weight='500' regular>{t('phone_number')}</AppText>
                                <AppTextInput placeholder={t('your_phone_number')} leftIcon={faPhone}/>
                            </AppBlock>
                            <AppBlock>
                                <AppText color='#554C46' size={16} weight='500' regular>{t('password')}</AppText>
                        ...
                        <AppBlock style={{width:'100%'}} alignItems='center' justifyContent='center' mt={20}>
                            <AppButton name={t('get_otp')} textStyle={{fontWeight: '600', fontSize: 16}} onPress={handleGetOTP} />
                        </AppBlock>
