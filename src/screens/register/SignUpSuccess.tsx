...
const SignUpSuccessfullyScreen = ({navigation}:any) => {
                ...
                <AppScreenWrapper>
                    <AppBlock flex alignItems='center' justifyContent='space-between' mt={100} style={{width: '100%'}}>
                        ...
                        <AppBlock alignItems='center' justifyContent='center' style={{width: '100%'}}>
                            <AppText size={24} weight='700' semiBold color='#122457' mt={20} mb={20}>{t('sign_up_successful')}</AppText>
                            <AppBlock style={{height: 350}} mv={20} alignItems='center' justifyContent='center'>
                                <ImageSlider
                                    images={[
                            ...
                            <AppText size={14} weight='600' color='#554C46' mt={20}>{t('description_sign_up_successful')}</AppText>
                        </AppBlock>
