...
import ItemInvesting from './components/ItemInvesting'



const HistoriesTradeScreen = () => {
  ...
  return (
    <AppSafeAreaView>
        ...
        <AppBlock style={{width:'95%'}} flex>
            ...
            <TouchableOpacity style={{width:'35%'}} onPress={()=>{setSelected('investing')}}>
                <AppBlock style={{width: '100%', borderBottomWidth: selected=='investing' ? 4 : 0, borderBottomColor:light.Primary}} pv={8} alignItems='center'>
                <AppText size={16} weight='500' color={selected=='investing' ? light.Primary: '#8C8C8C'}>{t('investing')}</AppText>
                </AppBlock>
            </TouchableOpacity>
            ...
            ?
                <AppBlock flex pv={12}>
                    <AppBlock row justifyContent='space-between'>
                        <AppText size={16} weight='500'>{t('investing')}</AppText>
                        <AppBlock>
                    ...
                    <FlatList
                        ...
                        renderItem={({item})=><ItemInvesting item={item} onPress={(item)=>{ setSelectedDetail(item); setDetailVisible(true)}}/>}
                        style={{flex:1}}
                    />
                </AppBlock>
            :
...
export default HistoriesTradeScreen